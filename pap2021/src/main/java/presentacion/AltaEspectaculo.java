...
public class AltaEspectaculo extends JInternalFrame {
	...
	protected void altaEspectaculoAceptarActionPerformed(ActionEvent arg0) {        
        if (checkFormulario()) {
        	...
        	try {
	            ...
	            JOptionPane.showMessageDialog(this, "Espect�culo dado de alta con �xito!", "Alta de Espect�culo",
	                        JOptionPane.INFORMATION_MESSAGE);
	            limpiarFormulario();
	            setVisible(false);
			} catch (AltaEspectaculoExcepcion e) {
				JOptionPane.showMessageDialog(this, e.getMessage(), "Alta de Espect�culo", JOptionPane.ERROR_MESSAGE);
			}
        }
	}
	...
	private boolean checkFormulario() {
    	String plataforma = (String)comboBoxPlataformas.getSelectedItem();
        if (plataforma == null) {
            JOptionPane.showMessageDialog(this, "Plataforma debe ser elegida", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
    	String artista = (String)comboBoxArtistas.getSelectedItem();
        if (artista == null) {
            JOptionPane.showMessageDialog(this, "Artista debe ser elegido", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        } 
        String nombre = txtNombre.getText();
        if (nombre.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nombre no puede ser vac�o", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Duraci�n debe ser num�rica", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Espectadores m�nimos debe ser num�rico", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Espectadores m�ximos debe ser num�rico", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Costo debe ser num�rico", "Alta de Espect�culo",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
